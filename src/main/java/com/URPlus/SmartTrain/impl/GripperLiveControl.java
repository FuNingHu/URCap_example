...
public class GripperLiveControl extends JPanel {
	...
	private final ContributionProvider<STProgramNodeContribution> provider;
	 ...
	 * @param programAPI
	 */
	public GripperLiveControl(ContributionProvider<STProgramNodeContribution> provider) {
